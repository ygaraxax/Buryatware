...
# Main window class for aim assist settings
...
"border: none;")
        ...
        # Raise order for proper layering
        self._setRaiseOrder()
...
"}")
    ...
    # Helper method to populate bone list
    ...
    # Helper method to set raise order
    def _setRaiseOrder(self):
